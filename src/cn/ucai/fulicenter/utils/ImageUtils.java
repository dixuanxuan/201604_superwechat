...
//	}
	...
	public  static  void  setGroupCategoryImage(Context context, ImageView imageView,String thumeb){
		String url= I.DOWNLOAD_DOWNLOAD_CATEGORY_GROUP_IMAGE_URL+thumeb;
		Picasso.with(context).load(url).placeholder(R.drawable.nopic).into(imageView);
	}
	public  static  void  setChildCategoryImage(Context context, ImageView imageView,String thumeb){
		String url= I.DOWNLOAD_DOWNLOAD_CATEGORY_CHILD_IMAGE_URL+thumeb;
		Picasso.with(context).load(url).placeholder(R.drawable.nopic).into(imageView);
	}
