...
public class BoutiqueDesc_Activity extends Activity {
    private  final  static  String TAG=BoutiqueDesc_Activity.class.getSimpleName();
    BoutiqueDesc_Activity mContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boutique_desc_);
        mContext=this;
    ...
    private void initData() {
        goodId=getIntent().getIntExtra(D.Category.KEY_CAT_ID,0);
        if (goodId>0){
    ...
    private void initView() {
       ...
       mSwipeRefreshLayout= (SwipeRefreshLayout) findViewById(R.id.srlBoutique);
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.rvBoutique);
