...
public class BuyActivity extends BaseActivity  implements PaymentHandler {
    public  final  static  String TAG=BuyActivity.class.getSimpleName();
        ...
        btnBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              String receiveName=edOrderName.getText().toString();
                ...
                String area=spOrderProvinc.getSelectedItem().toString();
                if (TextUtils.isEmpty(area)){
                    Toast.makeText(BuyActivity.this,"收货地址不能为空",Toast.LENGTH_SHORT).show();
                    return;
                }
                String stret=edOrderStreet.getText().toString();
