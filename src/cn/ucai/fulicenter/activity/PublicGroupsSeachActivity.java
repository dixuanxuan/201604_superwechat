                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            if(e.getErrorCode() == EMError.GROUP_NOT_EXIST){
                                Toast.makeText(getApplicationContext(), getResources().getString(cn.ucai.fulicenter.R.string.group_not_existed), Toast.LENGTH_SHORT).show();
                            }else{
                                Toast.makeText(getApplicationContext(), getResources().getString(cn.ucai.fulicenter.R.string.group_search_failed) + " : " + getString(cn.ucai.fulicenter.R.string.connect_failuer_toast), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
