...
public class OkHttpUtils2<T> {
    ...
    private void initHandler() {
        mHandler = new Handler(FuLiCenterServerApplication.applicationContext.getMainLooper()) {
            @Override
...
//        }
    ...
    public OkHttpUtils2<T> setRequestUrl(String request) {
        ...
        mUrl.append(I.QUESTION).append(I.KEY_REQUEST).append(I.EQUL).append(request);
